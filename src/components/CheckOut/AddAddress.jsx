...
import { userPostData } from '../../redux/user/userAction';
...
const handleSubmit = (e)=>{
    e.preventDefault();
    dispatch(userPostData(data,navigate,userAuth));
    ...
    return (
        <Box sx={{ mt: 5 }}>
            ...
            <Box sx={{ mt: 5, border: 0, display: "flex", alignItems: "center", m: "auto", width: "28%" }}>
                <CallIcon color="disabled" sx={{ fontSize: 30, mr: 2 }} /> <Typography variant="h5" component="h2">
                    Contact Details
                </Typography>
            </Box>
